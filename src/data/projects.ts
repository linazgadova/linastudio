...
export const PROJECTS: Project[] = [
...

  {
    ...
    summary: {
      ru: 'Агентство, которое начинает с исследования, а потом строит продукт. Логотип и палитру мне выдали готовыми, остальное я нарисовала и собрала: тридцать статических страниц, два языка, семь кейсов, дизайн-система из восьми размеров шрифта и один WebGL в первом экране.',
      en: 'An agency that starts with research and then builds the product. The logo and palette were handed to me; the rest I designed and built: thirty static pages, two languages, seven cases, a design system of exactly eight type sizes, and one WebGL field in the hero.',
    },
    url: 'https://testtnkerz.netlify.app/',
    year: '2025',
    role: { ru: 'Дизайн и сборка сайта', en: 'Design and site build' },
    kind: 'site',
    featured: false,
    color: '#FF2E8A',
    ink: '#C0176A',
    preview: ['/previews/thnkers.jpg'],
    layers: ['design', 'interface', 'logic', 'deploy'],
    notMine: {
      ru: 'Логотип, фирменная палитра и тексты кейсов пришли готовыми. Макеты страниц, типографика и сборка — мои.',
      en: 'The logo, the brand palette and the case copy came ready-made. The page layouts, the typography and the build are mine.',
    },
