...
/*
 * Приглашение в конце главной.
 *
 * Сюда доходят двумя разными дорогами. Одни ищут, кому отдать сайт,
 * другие смотрят, кого позвать в команду, и прежняя строка отвечала
 * только первым: «напишите, что нужно сделать» человеку с вакансией
 * сказать нечего.
 *
 * Поэтому сначала развилка, потом по обещанию на каждую ветку.
 * Обещания разные и оба проверяемые: по заказу — срок и граница
 * ответственности, по вакансии — резюме и разбор вслух.
 *
 * Страница услуг остаётся с прежней строкой: там развилки нет,
 * туда приходят только за работой на заказ.
 */
export const CONTACT = {
  title: { ru: 'Давайте поговорим', en: 'Let’s talk' } as L,
  lede: {
    ru: 'Напишите, что у вас: заказ или вакансия. По заказу отвечу, за какой срок это реально и что беру на себя. По вакансии пришлю резюме и разберу вслух любой проект отсюда.',
    en: 'Tell me which it is: a project or a job. For a project I’ll come back with a realistic timeline and the part I take on. For a job I’ll send a CV and walk through any project here out loud.',
  } as L,
}
