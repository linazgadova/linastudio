...
export const HIRE = {
  ...
  /* Видно только на телефоне: там таблица разложена в ленту
     карточек, и без подсказки непонятно, что вбок есть ещё шесть */
  swipe: { ru: 'Листайте вбок — семь проектов', en: 'Swipe sideways — seven projects' } as L,
  ...
  /*
   * Заголовок над адресами в файле для робота.
   *
   * На самой странице адресов нет: они стоят в подвале сразу под ней,
   * и повторять их значило бы дать человеку две одинаковые кнопки
   * подряд. А в голом тексте для робота подвала не существует вовсе,
   * и без этого блока страница осталась бы без единого контакта.
   */
