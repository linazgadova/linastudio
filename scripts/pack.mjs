...
console.log('')
console.log('  Заливай содержимое этой папки в корень сайта на хостинге.')
console.log('  Внутри всё, что нужно: страницы, правила сервера (.htaccess)')
console.log('  и блок с вопросами (api/ask.php).')
console.log('')
console.log('  Файл api/config.php с ключом сюда не кладётся и заливкой')
console.log('  не затирается: он живёт только на сервере. Пока его нет,')
console.log('  блок с вопросами отвечает поиском по данным самого сайта.')
